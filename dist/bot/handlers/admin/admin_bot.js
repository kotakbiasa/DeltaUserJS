/**
 * Bot admin utilities - re-exported from utils/permissions for backward compatibility.
 * New code should import directly from utils/permissions.ts instead.
 */
import { isAdmin, isGroupAdmin, isBotAdmin, isOwner } from '../../../utils/permissions.js';
export { isAdmin, isGroupAdmin, isBotAdmin, isOwner };
...
export function registerAdminHandlers(bot) {
    ...
    bot.command('ban', async (ctx) => {
        ...
        if (!target)
            return ctx.reply('❌ Harap balas (reply) pesan pengguna atau masukkan ID-nya.');
        try {
