...
import { buildHelpMenuHtml, buildModuleHtml, helpKeyboard, } from '../handlers/inlineHelp.js';
/** Map telegramId -> inline bot instance */
const inlineBots = new Map();
/** Validate token via getMe */
export async function validateInlineBot(token) {
    try {
 ...
 */
export async function sendHelpMenuViaInlineBot(token, chatId, page = 1, moduleArg = '') {
    try {
...
export async function startInlineBotForUser(telegramId, token) {
...
export async function stopInlineBotForUser(telegramId) {
