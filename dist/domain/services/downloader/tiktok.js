...
export class TikTokService {
    ...
    async download(url, id) {
        ...
        if (Array.isArray(item.play)) {
            ...
            if (paths.length === 0)
                throw new Error("TikTok slideshow download produced no files.");
            return paths;
        }
