...
const userbotSchema = new mongoose.Schema({
  ...
  is_telegram_premium: { type: Number, default: 0 },
...
export function normalizeBot(raw: any = {}, id?: any) {
  ...
  return {
    ...
    is_telegram_premium: pick('is_telegram_premium', 0),
    ...
    keyword_filters: raw.keyword_filters || {},
    pmguard_data: raw.pmguard_data || {},
    sudo_list: Array.from(raw.sudo_list || []),
