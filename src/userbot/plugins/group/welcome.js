import { getChatSettings, updateChatSettings } from '../../../core/database.js';
    ...
    if (message.action) {
      ...
      if (isJoin) {
        ...
        for (const uId of userIds) {
          ...
          const name = userEntity.firstName || userEntity.username || `User_${uId}`;
          ...
          const parsedMsg = welcomeTemplate
            ...
            .replace(/{title}/g, chatEntity.title || String(chatId));
